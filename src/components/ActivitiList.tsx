...
export default function ActivitiList({activities, dispatch}: ActivitiListProps) {
  ...
  return (
    <>
    <h2 className="text-4xl font-bold text-slate-600 text-center uppercase">Comida y Actividades</h2>
    ...
    activities.map(activity => (
        <div key={activity.id} className="px-5 py-10 bg-white mt-5 flex justify-between shadow">
            ...
            <div className="space-y-2 relative">
                <p className={`absolute -top-8 -left-8 px-10 uppercase py-2 text-white font-bold ${activity.category === 1 ? 'bg-lime-500' : 'bg-orange-500'}`}>
